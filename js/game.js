...
function equipmentGuideHtml(){
 return `<details class="relay-equip-guide"><summary>連戦専用装備について</summary><p>装備はこの連戦だけに適用されます。合計コスト${SKILL_MAX_COST}までで、発動スキルとパッシブは条件を満たすと自動で働きます。個体選択画面の「装備を変更」から選べます。</p></details>`;
}
