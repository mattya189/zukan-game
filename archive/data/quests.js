...
const QUESTS = [
  {
    ...
    enemy: { name: '草原の番人', guardian: 'gd_enemy_guard', guardianHp: 115, guardianGaugeRate: 1.8, guardianSkillUses: [3, 3], policy: 'defend',
    ...
    rules: [{ type: 'enemyPulse', every: 3, amount: 1 }], goalTurns: null,
    reward: { first: 500, repeat: 150 }
  },
  {
    id: 'q2', name: '霧の森の奥へ', level: 2,
    story: '深い霧が、森に入る者の体をむしばむ。',
    enemy: { name: '霧の森の住人', guardian: 'gd_enemy_mist', guardianHp: 98, policy: 'attack',
  ...
  },
  {
    ...
    enemy: { name: '料理長', guardian: 'gd_enemy_guard', guardianHp: 160, guardianGaugeRate: 1.5, guardianSkillUses: [3, 3], policy: 'attack',
    ...
    rules: [{ type: 'tribeBuff', tribe: '台所', atk: 1, hp: 2 }, { type: 'enemyPulse', every: 8, amount: 1 }],
    goalTurns: null,
    reward: { first: 800, repeat: 250 }
  },
  {
    ...
    enemy: { name: '風の一団', guardian: 'gd_enemy_war', guardianHp: 40, policy: 'attack',
  ...
  },
  {
    ...
    enemy: { name: '霧の主', guardian: 'gd_enemy_mist', guardianHp: 40, policy: 'big', ultimates: true,
